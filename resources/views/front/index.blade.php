...
<div class="wrapper" >
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="margin-right: 0px">
        ...
        <ul class="navbar-nav">
            ...
            @endif
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{route('contact')}}" class="nav-link">{{__('msg.Contact Us')}}</a>
            </li>
    ...
    <div class="content-wrapper" style="margin-right: 0px">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="">
                        <ol class="breadcrumb float-sm-right" style="margin-right: 500px">
                            <li class="breadcrumb-item"><a href="#">{{__('msg.MainPage')}}</a></li>
        ...
        <!-- Main content -->
        <a class="content" href="{{ route('pay') }}" data-id="5" id="btn_click">

            <img src="{{asset('portal/dist/img/credit/update_site.jpg')}}" class="mx-auto d-block" style="margin-right: 500px" alt="Cinque Terre">
        </a>
        <!-- /.content -->
    </div>
    <!-- /.content-wrapper -->
